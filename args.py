...
def _add_common_args(arg_parser):
    ...
    arg_parser.add_argument('--xml_path', type=str, help="Path to ground truth xml")
    arg_parser.add_argument('--detection_path', type=str, help="Path to visual grounding")
    ...
    arg_parser.add_argument('--vit_name', default="clip-vit-base-patch32", type=str, help="The name of vit.")
    arg_parser.add_argument('--path_num', default=10, type=int, help="default patch")
    arg_parser.add_argument('--image_path', default="../MMKG/GMNER/Twitter10000_v2.0/whole_image", type=str, help="The raw image path")
    arg_parser.add_argument('--aux_size', default=128, type=int, help="region size")
    arg_parser.add_argument('--rcnn_size', default=64, type=int, help="rcnn size")
    arg_parser.add_argument('--loss_region_weight', default=2.0, type=float, help="loss region weight")
    arg_parser.add_argument('--match_region_weight', default=2.0, type=float, help="match region weight")
    arg_parser.add_argument('--region_threshold', default=0.0, type=float, help="region classification threshold")
    arg_parser.add_argument('--candidate_regions_num', default=15, type=int, help="candidate visual regions quantity")
...
def eval_argparser():
    ...
    arg_parser.add_argument('--checkpoint_path', default="", type=str, help="The path of model checkpoint.")
